...
START_PORT_DEFAULT='2000'
MIN_PORT=100
MAX_PORT=65520
MIN_HOPPING_PORT=10000
MAX_HOPPING_PORT=65535
TLS_SERVER_DEFAULT=www.nvidia.com
PROTOCOL_LIST=("VLESS + Reality + uTLS + Vision" "Xray-core")
NODE_TAG=("vless-reality" "xray-core")
...
E[0]="语言:\n 1. 简体中文 (默认) \n 2. English"
C[0]="${E[0]}"
E[1]="1. 默认使用简体中文; 2. 配置Xray-core和VLESS+Reality+uTLS+Vision; 3. 伪装站点为www.nvidia.com"
C[1]="${E[1]}"
E[2]="Downloading Sing-box. Please wait a seconds ..."
C[2]="下载 Sing-box 中，请稍等 ..."
E[3]="Input errors up to 5 times.The script is aborted."
C[3]="输入错误达5次,脚本退出"
E[4]="使用随机UUID: \${UUID_DEFAULT}"
C[4]="${E[4]}"
...
E[12]="\(5/6\) 使用随机UUID: \${UUID_DEFAULT}"
C[12]="${E[12]}"
E[13]="\(6/6\) 使用随机用户名: \${NODE_NAME_DEFAULT}"
C[13]="${E[13]}"
...
E[49]="(1/6) 选择安装协议:\n 1. VLESS + Reality + uTLS + Vision [推荐]\n 2. Xray-core"
C[49]="${E[49]}"
...
E[97]="配置防火墙并开放2000端口:\nsudo DEBIAN_FRONTEND=noninteractive NEEDRESTART_MODE=a apt update && sudo DEBIAN_FRONTEND=noninteractive NEEDRESTART_MODE=a apt install -y ufw && echo \"y\" | sudo ufw enable && sudo ufw allow 2000/tcp && sudo ufw status"
C[97]="${E[97]}"
